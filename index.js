...
for (let i = 0; i < plansList.length; i++) {
    ...
    rows[4].appendChild(icon);
    
    let binaryFeature1 = document.createElement("th");
    ads.textContent = plansList[i].binaryFeature1;
   ads.textContent= toEmoji(binaryFeature1.textContent);
    rows[5].appendChild(binaryFeature1);
    
    let ultimaeam = document.createElement("th");
